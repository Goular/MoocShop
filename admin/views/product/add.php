        ...
        <div id="pad-wrapper" class="new-user">
            ...
            <div class="row-fluid form-wrapper">
                ...
                <div class="span9 with-sidebar">
                    <div class="container">
                        <form id="w0" class="new_user_form inline-input" action="/index.php?r=admin%2Fproduct%2Fadd"
                              method="post" enctype="multipart/form-data">
                            <input type="hidden" name="_csrf"
                                   value="LjJsTTRjRURcfAsrTFFoLh8KDR1MFTARXwINAWEADTJKdT00BhcGNg==">
                            ...
                            <div class="form-group field-wysi required">
                                <div class="span12 field-box">
                                    ...
                                    <textarea id="wysi" class="span9 wysihtml5" name="Product[descr]"
                            ...
                            <div class="form-group field-product-saleprice">
                                <div class="span12 field-box">
                                    ...
                                    <input type="text" id="product-saleprice" class="span9" name="Product[saleprice]">
                                </div>
                                <p class="help-block help-block-error"></p>
                            </div>
                            ...
                            <div class="form-group field-product-pics">
                                <div class="span12 field-box">
                                    ...
                                    <input type="file" id="product-pics" class="span9" name="Product[pics][]" multiple>
                                </div>
                                <p class="help-block help-block-error"></p>
                            </div>
                            <hr>
