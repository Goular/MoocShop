                            ...
                            <div class="row">
                                <div class="col-xs-4 col-sm-4 no-margin">
                                    <a href="<?php echo yii\helpers\Url::to(['product/detail', 'productid' => $pro['productid']]) ?>"
                                       class="thumb-holder">
                                        <img alt="" src="<?php echo $pro['cover'] ?>-CoverSmallProduct"/>
                                    </a>
                                </div>
                            ...
                            <div class="product-item">
                                ...
                                <div class="prices">
                                    <div class="price-current text-right">
                                        ￥ <?php echo $pro['issale'] ? $pro['saleprice'] : $pro['price'] ?></div>
                                </div>
                                    ...
                                    <?php foreach ($all as $pro): ?>
                                        <div class="col-xs-12 col-sm-4 no-margin product-item-holder hover">
                                            <div class="product-item">
                                                ...
                                                <div class="body">
                                                    <?php if ($pro['issale']): ?>
                                                        <div class="label-discount green"><?php echo round($pro['saleprice'] / $pro['price'] * 100, 0) ?>
                                                            % sale
                                                        </div>
                                                    <?php endif; ?>
                                                    <div class="title">
                                            ...
                                            <div class="no-margin col-xs-12 col-sm-3 price-area">
                                                <div class="right-clmn">
                                                    ...
                                                    <?php else: ?>
                                                        <div class="price-current">￥<?php echo $pro['price'] ?></div>
                                                    <?php endif; ?>
                                                    <div class="availability"><label>库存:</label><span
                                                                class="available">  <?php echo $pro['num'] ?></span>
                                                    </div>
                                                    <a class="le-button"
                                                       href="<?php echo yii\helpers\Url::to(['cart/add', 'productid' => $pro['productid']]) ?>">加入购物车</a>
                                                </div>
                                            </div><!-- /.price-area -->
                                        </div><!-- /.row -->
                                    </div><!-- /.product-item -->
